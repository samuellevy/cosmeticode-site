...
import { Background, Container, Content } from "./beneficios-para-o-profissional.style";
import { DesktopOnly, MobileOnly } from "@/presentation/styles/global.style";

const beneficios = [
  {
    title: "Economia de tempo",
    description: "Respostas objetivas em poucos cliques durante o atendimento.",
    banner_url: "/beneficios-para-o-profissional/economia-de-tempo.jpg",
  },
  {
    title: "Decisão mais segura",
    description: "Protocolos de injeção, diluições, indicações e contraindicações de procedimentos. ",
    banner_url: "/beneficios-para-o-profissional/decisao-mais-segura.png",
  },
  {
    title: "Manejo de intercorrências",
    description: "Condutas rápidas em eventos adversos para o melhor cuidado com os pacientes. ",
    banner_url: "/beneficios-para-o-profissional/manejo-de-intercorrencias.png",
  },
  {
    title: "Favoritos e anotações pessoais",
    description: "Faça anotações e salve os conteúdos favoritos para facilitar a busca. ",
    banner_url: "/beneficios-para-o-profissional/favoritos-e-anotacoes-pessoais.png",
  },
  {
    title: "Acesso multiplataforma",
    description: "Acesse o aplicativo pelo celular, iPad e pelo computador, no consultório ou em movimento.",
    banner_url: "/beneficios-para-o-profissional/acesso-multiplataforma.png",
  },
];
...
export const BeneficiosParaOProfissional = () => {
  ...
  return (
    <Container>
      <Background alt="" src="/beneficios-para-o-profissional/background.png" />

      <SectionHeader caption="Seu melhor guia em cosmiatria" title="Benefícios para o profissional" />
