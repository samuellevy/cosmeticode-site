...
const data = [
  {
    ...
    description: "Encontre rapidamente por marca, <br /> categoria e indicação clínica.",
  },
  {
  ...
  },
  {
    ...
    description: "Orientações de manejo para eventos adversos <br /> frequentes ou graves, com foco em segurança.",
  },
  {
...
export const Beneficios = () => {
  const slides = [
    () => <BeneficioUi description={data[0].description} title={data[0].title} />,
    () => <BeneficioUi description={data[1].description} title={data[1].title} />,
    () => <BeneficioUi description={data[2].description} title={data[2].title} />,
    () => <BeneficioUi description={data[3].description} title={data[3].title} />,
    () => <BeneficioUi description={data[4].description} title={data[4].title} />,
  ];
