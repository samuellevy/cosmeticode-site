...
export const Topics = () => {
    ...
    const slides = [
        () => (
            <TopicUi
                $iconColor={theme.colors['primary-pure']}
                imageUrl={data[0].icon_url}
                title={data[0].name}
            />
        ),
        () => (
            <TopicUi
                $iconColor={theme.colors['secondary-medium']}
                imageUrl={data[1].icon_url}
                title={data[1].name}
            />
        ),
        () => (
            <TopicUi
                ...
                imageUrl={data[2].icon_url}
                title={data[2].name}
            />
        ),
        () => (
            <TopicUi
                $iconColor={theme.colors['tertiary-dark']}
                imageUrl={data[3].icon_url}
                title={data[3].name}
            />
        ),
        () => (
